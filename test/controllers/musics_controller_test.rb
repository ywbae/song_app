...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post musics_url, params: { music: { body: @music.body, youtube_url: @music.youtube_url } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { body: @music.body, youtube_url: @music.youtube_url } }
